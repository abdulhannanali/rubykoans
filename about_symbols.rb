...
class AboutSymbols < Neo::Koan
  ...
  # So you should be sure if you are going to use the symbol created or not
  # otherwise it leads to you creating many symbols in the computer's 
  # memory which can't be freed untill you end the program.
end
